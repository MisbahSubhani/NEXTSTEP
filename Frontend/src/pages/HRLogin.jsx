...
export function HRLogin() {
  ...
  const handleLogin = async (e) => {
    ...
    try {
      ...
      }, 1500); // small delay to show loader
      ...
      <div className="bg-gradient-to-r from-[#1c1a3b] via-[#903d37] to-[#903d37] flex items-center justify-center h-screen w-full px-5 sm:px-0">
        <div className="flex bg-white rounded-lg shadow-lg border overflow-hidden max-w-sm lg:max-w-4xl w-full">
          <div
            ...
            style={{
              backgroundImage: `url(https://images.unsplash.com/photo-1606607291535-b0adfbf7424f?q=80&w=1974&auto=format&fit=crop&ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D)`,
            }}
          ></div>
